...
File_psf_s2 = h5py.File('../../O_cen_2D/PSF_S2_2D.h5py','r')
...
def no_events_MSP(pars):
    ...
    events_vec = np.zeros((15,int(40*40)))
    for i in range(15):
...
def no_events_Background():
    ...
    return Background_map.reshape((15,int(40*40)))
...
def lnhood(pars):
    ...
    for i in range(15):
        ...
        H1_matrix = MSP_mask + S1_mask + S2_mask+ back[mask]
...
if __name__ == "__main__":
    ...
    #print(lnhood([1.55812824,5.97957804,-9.3947961,-10.23321955,1.06061974,-12.73516308,1.58944231]))