...
#here i call the total likelihood
fun = lambda *args: -(lnhood1(*args) + lnhood2(*args))
mid = [10.,-10.0,-6.,1.5,-6.,1.5]
bnds = ((0.5,20.),(-20.,0.),(-20.,0.),(0.,5.),(-15.,0.),(0.,5.))

#here i find the maximun likelihood to initialize my chains in high prob zone
...
print sampler.acceptance_fraction.mean()
np.savetxt('chains/DM_uu_nocondition_2bins.dat',sampler.flatchain)
