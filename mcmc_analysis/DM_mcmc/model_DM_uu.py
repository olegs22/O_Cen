...
"""
#here i apply the semianalytic model for the uu, we are supposing that the alphas
...
def dnde(mass_x,energy):
    ...
    return val
#this is the model for the first nearby source
...
#same as above but for the second source.
...
#here a calculate the number of events for the DM
...
#here i define the likelihood for the first source
...
#the likelihood fot the second source.
