...
path = '../../O_cen_2D/P8R3/'
events, Ocen_exp, Ocen_psf, background = np.loadtxt(path + 'OC_no_events_15_bins_0.15_degree.txt',usecols=(1,4,5,6),unpack=True)#9 bin data
Ps_exp2, Ps_psf2 = np.loadtxt(path + 'source2_J1328_0.15_degree.txt',usecols=(2,3),unpack=True)#9 bin data
